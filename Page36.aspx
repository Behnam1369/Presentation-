<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Page36.aspx.cs" Inherits="Presentation.Page36" MasterPageFile="M1.Master" %>
...
.tooltip:hover .tooltiptext {
    ...
    <div style="text-align: center">
        <table style="width: 100%">
            <tr>
                <td colspan="2">
                    <p class="hdr" style="text-align: center">مدل سوم</p>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <p style="font-family: Cambria Math; font-size: 20px; font-weight: bold; vertical-align: middle">    
                    <i id="i" class="tooltip"> ∆Cash 
                        <span id="s" class="tooltiptext">نسبت تغییرات وجه نقد به مجموع دارایی ها</span> 
