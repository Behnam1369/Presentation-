<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Page34.aspx.cs" Inherits="Presentation.Page34" MasterPageFile="M1.Master" %>
...
.tooltip:hover .tooltiptext {
    ...
    <div style="text-align: center">
        <table style="width: 100%">
            <tr>
                <td colspan="2">
                    <p class="hdr" style="text-align: center">مدل اول</p>
                </td>
            </tr>
            <tr>
                <td>
